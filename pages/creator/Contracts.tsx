...
import { Search, Filter, Calendar, DollarSign, ChevronRight, Star } from 'lucide-react';
          ...
          {filteredContracts.length > 0 ? (
            <div className="divide-y divide-slate-100 dark:divide-slate-800">
              {filteredContracts.map(contract => {
                ...
                // Since this is the Creator Contracts page, check if Creator has reviewed
                const needsReview = isCompleted && !contract.isCreatorReviewed;
